...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./log/classify_finetune',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./classify_finetune',
...
def main(args):
    ...
    optimizer = LARS(model.parameters(), lr=args.lr, weight_decay=0)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % 5 == 0 or epoch + 1 == args.epochs):
            ...
            torch.save(model, f"./classify_finetune/epoch-{epoch}")
